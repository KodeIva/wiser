...
const Billing = () => {
  return (
    <section id='product' className='flex mf:flex-row flex-col-reverse sm:py-16 py-6'>
      <div className='flex-1 flex justify-center items-center md:mr10 mr-0 md:mt-0 mt-10 relative'>
